...
TRUNCATE TABLE hoh_datamart.atfarm_user_monthly_weekly_ss;

COPY hoh_datamart.atfarm_user_monthly_weekly_ss 
FROM 's3://%S3_BUCKET_NAME%/one21/atfarm_user_monthly_weekly_ss_manifest' 
