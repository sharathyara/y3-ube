...
--changeset sandeep_c:ATI-6926-hoh-datamart-atfarm_user_activity_daily_agg-table-creation splitStatements:true
--comment: ATI-6926 - hoh datamart atfarm_user_activity_daily_agg table creation
...
-- rollback DROP TABLE IF EXISTS hoh_datamart.atfarm_user_activity_daily_agg;


--changeset sandeep_c:ATI-6926-hoh-datamart-atfarm_user_monthly_weekly_ss-table-creation splitStatements:true
--comment: ATI-6926 - hoh datamart atfarm_user_monthly_weekly_ss table creation
...
-- rollback DROP TABLE IF EXISTS hoh_datamart.atfarm_user_monthly_weekly_ss;


--changeset sandeep_c:ATI-6926-hoh-datamart-atfarm_field_monthly_weekly_ss-table-creation splitStatements:true
--comment: ATI-6926 - hoh datamart atfarm_field_monthly_weekly_ss table creation
...
-- rollback DROP TABLE IF EXISTS hoh_datamart.atfarm_field_monthly_weekly_ss;


--changeset sandeep_c:ATI-6926-hoh-datamart-atfarm_country_crop_farm_user_monthly_weekly_agg-table-creation splitStatements:true
--comment: ATI-6926 - hoh datamart atfarm_country_crop_farm_user_monthly_weekly_agg table creation
...
-- rollback DROP TABLE IF EXISTS hoh_datamart.atfarm_country_crop_farm_user_monthly_weekly_agg;


--changeset sandeep_c:ATI-6926-hoh-datamart-atfarm_country_crop_monthly_agg_log-table-creation splitStatements:true
--comment: ATI-6926 - hoh datamart atfarm_country_crop_monthly_agg_log table creation
...
-- rollback DROP TABLE IF EXISTS hoh_datamart.atfarm_country_crop_monthly_agg_log;


--changeset sandeep_c:ATI-6926-hoh-datamart-atfarm_country_crop_quarterly_agg_log-table-creation splitStatements:true
--comment: ATI-6926 - hoh datamart atfarm_country_crop_quarterly_agg_log table creation
...
-- rollback DROP TABLE IF EXISTS hoh_datamart.atfarm_country_crop_quarterly_agg_log;