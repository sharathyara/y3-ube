...
dataSourceQueryDF = spark.read.format('org.apache.hudi').load('s3://' + source_bucket_name + f'/hudi-cdc-tables/{hudi_table_name}' + '/*/*').select("dateTimeOccurred", "sourceFile_name", "sourceFile_receivedDate", "sourceSeasonId", "sourceFieldId", "seasonName", "cropRegionId", "growthStageId", "growthStageSystem", "startDate", "endDate","plantingDate","expectedYieldDetails", "additionalParameters", "fieldSize", "fieldSizeUOMId", "feature", "center", "geoHash", "geometryHash", "eventSource", "eventType", "eventId", "created_at").filter("created_at >= '2022-09-05'")
