...
dataSourceCuratedDF = dataSourceQueryDF.na.fill("", subset=["feature"])

dataSourceCuratedDF.show(5)
logger.info(log_former.get_message(f'{hudi_table_name} Schema'))
  
dataSourceFilteredDyF = DynamicFrame.fromDF(dataSourceCuratedDF, glueContext, "dataSourceFilteredDyF")
