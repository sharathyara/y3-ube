...
fieldList = ["listOfReadings","listOfAnswers","data"]
...
dataSourceQueryDF = spark.read.format('org.apache.hudi').load('s3://' + source_bucket_name + f'/hudi-cdc-tables/{hudi_table_name}' + '/*/*').select("dateTimeOccurred","farmId","fieldId","location","seasonId","resultDate","cropId","expectedYield","expectedYieldUOMId","cropDescriptionId","calculationType","value","valuetype","createdBy","createdAt","listOfReadings","listOfAnswers","notes","message","messageKey","warningMessage","warningMessageKey","productRecommendation","pdfURL","nitrogenSufficiencyIndex","id","data","eventsource", "eventtype", "eventid","recommendationType","fieldname","fieldarea","countryid","updatedat","deletedat","recommendationvalue","updatedby")
