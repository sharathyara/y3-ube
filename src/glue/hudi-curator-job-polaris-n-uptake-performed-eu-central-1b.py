...
dataSourceQueryDF = spark.read.format('org.apache.hudi').load('s3://' + source_bucket_name + f'/hudi-cdc-tables/{hudi_table_name}' + '/*/*').select("dateTimeOccurred", "request_boundaries", "request_cropRegionId", "request_date", "request_extrapolation", "request_field_area", "request_field_areaUnitId", "request_configuration_requestType", "request_configuration_callbackUrl", "response_success", "response_message", "response_payload_imageUrl", "response_payload_cloudCoverage", "response_payload_snowCoverage", "response_payload_valid", "response_payload_min", "response_payload_max", "response_payload_mean", "response_payload_std", "response_payload_growthScaleId", "response_payload_fromGrowthStageId", "response_payload_toGrowthStageId", "configuration_solution", "eventSource", "eventType", "eventId", "created_at")
