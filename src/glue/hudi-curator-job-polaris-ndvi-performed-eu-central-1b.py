...
dataSourceQueryDF = spark.read.format('org.apache.hudi').load('s3://' + source_bucket_name + f'/hudi-cdc-tables/{hudi_table_name}' + '/*/*').select("dateTimeOccurred","request_boundaries", "request_cropRegionId", "request_date", "area", "areaUnitId", "requestType", "callbackUrl", "success", "message", "imageUrl", "cloudCoverage", "snowCoverage", "valid", "image_date", "solution", "eventSource", "eventType", "eventId", "created_at")
