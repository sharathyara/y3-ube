...
fieldList = ["request_additionalParameters","request_analysis","request_organicProducts","response_baseData","response_demandData","response_organicSupply"]
super_datatype_columns = ["request_field_boundaries","request_additionalParameters","request_analysis","request_organicProducts","response_baseData","response_demandData","response_organicSupply"]
...
dataSourceQueryDF = spark.read.format('org.apache.hudi').load('s3://' + source_bucket_name + f'/hudi-cdc-tables/{hudi_table_name}' + '/*/*').select("dateTimeOccurred","request_countryId","request_regionId","request_field_id","request_field_boundaries","request_field_area","request_field_areaUnitId","request_field_soilTypeId","request_cropRegionId","request_yield","request_yieldUnitId","request_cropResidueManagementId","request_additionalParameters","request_precrop_cropDescriptionId","request_precrop_yield","request_precrop_yieldUnitId","request_precrop_cropResidueManagementId","request_postcrop_cropDescriptionId","request_postcrop_yield","request_postcrop_yieldUnitId","request_postcrop_cropResidueManagementId","request_analysis","request_requestType","request_callbackUrl","request_soilAnalysisType","request_useDefaultData","request_organicProducts","response_id","response_success","response_begin","response_end","response_message","response_baseData","response_demandData","response_organicSupply","solution","eventSource","eventType","eventId","created_at")
