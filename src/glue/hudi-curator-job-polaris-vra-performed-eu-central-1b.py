...
fieldList = ["response_bucketZones","response_zonedZones","response_indices"]
...
dataSourceQueryDF = spark.read.format('org.apache.hudi').load('s3://' + source_bucket_name + f'/hudi-cdc-tables/{hudi_table_name}' + '/*/*').select("dateTimeOccurred","request_boundaries", "request_cropRegionId", "request_date", "request_field_area", "request_field_areaUnitId", "request_requestType", "request_callbackUrl","request_dMax","request_dMin","request_dTarget","request_growthStage","request_vraType","request_protein","request_featureCollection","request_valuekey","request_extrapolation","response_success","response_message","response_date", "response_cloudCoverage", "response_snowCoverage", "response_valid","response_cellSize","response_bucketZones","response_zonedZones","response_indices","response_bucketMean","response_bucketMin","response_bucketMax","response_bucketStd","response_zonedMean","response_zonedMin","response_zonedMax","response_zonedStd","response_featureCollection","solution", "eventSource", "eventType", "eventId", "created_at")
